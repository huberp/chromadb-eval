 ...
 * 
 * NOTE: When changing the default model ID here, also update webapp/config.js so that
 * the pre-computed embeddings and the live in-browser query embeddings use the same model.
 */
